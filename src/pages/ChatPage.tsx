  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center px-4 animate-fade-in">
      ...
      <p className="text-sm text-muted-foreground max-w-sm">
        Send a message to begin chatting with our AI assistant. We're here to help!
      </p>
    </div>
  )
}
  ...
  if (!token) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-background via-background to-muted/20">
        <Card className="p-8 space-y-4 max-w-md w-full text-center shadow-lg border-border/50">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Please log in to access the chat and start conversations with our AI assistant.
          </p>
        ...
        <div className="flex justify-between items-center mb-6 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Support assistant</p>
            </div>
          </div>
